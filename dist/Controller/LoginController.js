...
var loginController = exports.loginController = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, email, password, userdb, user, isPasswordValid, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, email = _req$body.email, password = _req$body.password; // Vérifier si l'email existe et récupérer l'utilisateur en un seul appel SQL
          _context.next = 4;
        ...
        case 7:
          user = userdb[0][0]; // **Comparaison du mot de passe en texte clair avec celui haché dans la base de données**
          _context.next = 10;
          return _bcrypt["default"].compare(password, user.passwordd);
        case 10:
        ...
        case 19:
          ...
          console.error('Login Error:', _context.t0); // Affiche l'erreur complète dans la console
          return _context.abrupt("return", res.status(500).json({
            resp: false,
            msg: _context.t0.message // Renvoie le message d'erreur exact
          }));
        case 23:
        case "end":
...
var renewTokenLogin = exports.renewTokenLogin = /*#__PURE__*/function () {
  ...
  return function renewTokenLogin(_x3) {
