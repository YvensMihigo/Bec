...
var getUserUpdated = exports.getUserUpdated = /*#__PURE__*/function () {
...
var changeImageProfile = exports.changeImageProfile = /*#__PURE__*/function () {
...
var getAddressesUser = exports.getAddressesUser = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.prev = 1;
          _context6.next = 4;
          return _mysql["default"].query('SELECT a.id, CONCAT(a.numero_maison, ",", a.avenue, ",",a.commune,",",a.province,",",a.pays) as pays, a.reference, a.Latitude, a.Longitude, p.phone as phone FROM addresses as a INNER JOIN Person as p ON a.persona_id = p.uid WHERE a.persona_id = ?', [req.uid]);
        case 4:
...
var deleteStreetAddress = exports.deleteStreetAddress = /*#__PURE__*/function () {
      ...
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 7:
          ...
          return _context7.abrupt("return", res.status(500).json({
            resp: false,
            msg: 'Cette adresse est déjà utilisée dans une commande et ne peut pas être supprimée.'
          }));
        case 10:
        case "end":
...
var addStreetAddress = exports.addStreetAddress = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          _context8.prev = 1;
          _req$body3 = req.body, pays = _req$body3.pays, province = _req$body3.province, commune = _req$body3.commune, avenue = _req$body3.avenue, numero_maison = _req$body3.numero_maison, instruction_speciale = _req$body3.instruction_speciale, reference = _req$body3.reference, latitude = _req$body3.latitude, longitude = _req$body3.longitude;
          _context8.next = 5;
          return _mysql["default"].query('INSERT INTO addresses (pays, province, commune, avenue, numero_maison, instruction_speciale, reference, Latitude, Longitude, persona_id) VALUE (?,?,?,?,?,?,?,?,?,?)', [pays, province, commune, avenue, numero_maison, instruction_speciale, reference, latitude, longitude, req.uid]);
        case 5:
          res.json({
            resp: true,
...
var getAddressOne = exports.getAddressOne = /*#__PURE__*/function () {
...
var updateNotificationToken = exports.updateNotificationToken = /*#__PURE__*/function () {
...
var getAdminNotificationToken = exports.getAdminNotificationToken = /*#__PURE__*/function () {
...
var updateDeliveryToClient = exports.updateDeliveryToClient = /*#__PURE__*/function () {
